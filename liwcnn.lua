...
-- [[ ESP - TO BẰNG NHÂN VẬT, KHÔNG KHOẢNG CÁCH ]] --
local ESP_Boxes = {}
...
game.StarterGui:SetCore("SendNotification", {
    Title = "LIWCN PRO MAX",
    Text = "Menu fix + ESP to bằng nhân vật!",
    Duration = 5
})
